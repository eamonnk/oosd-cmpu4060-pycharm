...
class MatchAnalysis:
    ...
    def create_widgets(self):
            ...
            self.sports_time_combo=ttk.Combobox(self.frame1_sports, values=('09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00'), state="readonly", width=10)
            ...
            sports_finished_match_csv_ref_label= tk.Label(self.frame1_sports, text='Match data has also been saved to the file \'match_analysis.csv\' for future reference.')
            sports_finished_match_csv_ref_label.grid(row=17, column=0, padx=5, pady=5, columnspan=3, sticky='w, e')
            ...
            sports_finished_match_button.grid(row=18, column=0, padx=10, pady=5, sticky='e')
            ...
            sports_frame1_user_guide_button.grid(row=18, column=2, padx=10, pady=5, sticky='w')
            
            
            # sports_finished_match_csv_label= tk.Label(self.frame1_sports, text='Match data has also been saved to the file \'match_analysis.csv\' for future reference. It is located alongside this python file.')
            # sports_finished_match_csv_label.grid(row=18, column=0, padx=5, pady=5, sticky='w')
